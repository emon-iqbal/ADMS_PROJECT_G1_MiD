...
const userModel		 = require.main.require ('./models/gymbeemer_users');
...
//>>>>>>>>>>>>>>get,post for TD_Profile>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
				...
				router.get('/TD_Profile', (req, res) =>
				{
						...
						{
							res.render('td_DASHBOARD/TD_Profile', { gymbeemer_users : results, username: req.session.username});
				...
				router.get('/tdPHOTO', (req, res) =>
				{
					...
					userModel.getByUname(username, (results) =>
					{
						res.render('td_DASHBOARD/tdPHOTO', { gymbeemer_users : results, username: req.session.username});
					});
				...
				router.get('/TD_Profile/update/:userid', (req, res) =>
				{
						...
						{
								res.render('td_DASHBOARD/TD_profileUpdate', {gymbeemer_users: result});
						});
